...
const Home = () => {
  ...
  const [textWidths, setTextWidths] = useState([0, 0, 0]);

  const texts = ["AI Editing", "Smart Tools", "Virtual Try-On"];
  ...
  useEffect(() => {
    ...
    context.font = 'clamp(2.5rem, 8vw, 4rem) 400 Roboto, sans-serif';
              ...
              <div className="inner text-center mt--140">
                   ...
                   <span 
                     ...
                     style={{ 
                       ...
                       transform: `translateX(${textWidths[visibleIndex] * 1}px)`
                     }}
                   >
                     Technology
                   </span>
                ...
                <p className="description">
                  Create stunning professional photos with AI-powered editing tools. <br />{" "}
                  Enhance, retouch, and transform your images effortlessly
                </p>
                <div className="form-group">
                  <textarea
                    ...
                    cols="30"
                    rows="2"
                    placeholder="Describe your photo editing needs, for example: enhance portrait photo, remove background, or apply vintage filter"
                  ></textarea>
                  <Link className="btn-default " href="/image-editor">
            ...
            <div className="col-lg-12">
              ...
              >
                <p className="b1 mb--0 small-title">
                  Trusted by 800,000+ Professional Photographers & Creators
                </p>
              </div>
            </div>
          </div>
              ...
              >
                <h4 className="subtitle">
                  <span className="theme-gradient">
                    STITCHFORGE UNLOCKS THE POTENTIAL OF AI
                  </span>
                </h4>
                <h2 className="title mb--0">
                  Professional Photo Editing <br /> made for creators.
                </h2>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle">
                  <span className="theme-gradient">Empowering photographers</span>
                </h4>
                <h2 className="title mb--60">
                  Edit Smarter, Not <br /> Harder with
                </h2>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle ">
                  <span className="theme-gradient">AI Photo Enhancement</span>
                </h4>
                <h2 className="title mb--20">
                  Professional photo editing for seamless
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle">
                  <span className="theme-gradient">Trusted by professionals</span>
                </h4>
                <h2 className="title mb--60">What photographers say about us</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                ...
                <p className="subtitle mb--0">Based on 20,000+ photographer reviews</p>
              </div>
            </div>
          </div>
          <BrandTwo />
